...
function buildPrompt(rawText) {
    return [
        ...
        "-experience: jobs most recent first,with company,role,period (preserve original data format),location if available,and bullet points",
        "-skills: flat array of technical skills",
        "-projects: name,one-sentence description,optional tech tags,optional links",
        "-certifications: na,e,issuer,year",
        "-languages:flat array",
        "-interests: flat array",
        "",
        "Rules:",
        "-Be conversative: omit fields that are not clearly present. Use empty strings/arrays where missing",
        "-Do not invent or paraphrase -extract verbatim where possible",
        "-Each experience bullet should read as a complete sentence.",
        "-Preserve original date formats(e.g. 'Jan 2022-Dec 2022').",
        "",
        "RESUME TEXT",
        "-------",
        rawText,
